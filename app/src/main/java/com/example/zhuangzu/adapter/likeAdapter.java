...
import com.example.zhuangzu.databinding.ArticleLikeItemBinding;
...
public class likeAdapter extends RecyclerView.Adapter<likeAdapter.ViewHolder> implements View.OnClickListener{
    ...
    public likeAdapter(Context context, ArrayList<Article> articles){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ArticleLikeItemBinding itemBinding = ArticleLikeItemBinding.inflate(LayoutInflater.from(parent.getContext()),
                parent,false);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull ArticleLikeItemBinding binding) {
